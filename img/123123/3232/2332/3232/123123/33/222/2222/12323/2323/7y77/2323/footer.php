...
<div class="form als" id="order_link">
	...
	array(
		...
		"FIELDS_ORDER" => "LINK,TITLE,EMAIL,PHONE,COMPANY,ACCEPT",
		"FORM_AUTOCOMPLETE" => "Y",
		"FORM_ID" => "LINK",
		...
		"CATEGORY_ACCEPT_VALUE" => "Я ознакомлен и согласен с <a href=\"/privacy/\" target=\"_blank\">условиями сбора и обработки  персональныx данных</a>",
		"CATEGORY_ACCEPT_VALIDATION_ADDITIONALLY_MESSAGE" => "",
		"CATEGORY_FILE_DROPZONE_INCLUDE" => "N",
		"CATEGORY_ACCEPT_VALIDATION_MESSAGE" => "Обязательное поле",
		"COMPONENT_TEMPLATE" => "catalog",
		"CUSTOM_FORM" => "",
		"CAPTCHA_TITLE" => "",
		"CATEGORY_COMPANY_VALIDATION_MESSAGE" => "Обязательное поле"
	),
	false
);?>
    </div>
