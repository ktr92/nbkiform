...
?>
<div class="container">
	<div class="pagecontent  corppage_v4 nbki_v4 corppage_insur">
				...
				<div class="itemcardlist__item itemcardlist__item_col3 itemcardlist__item_icon">
					<div class="itemcard">
						<div class="itemcard__wrapper">
							...
							<div class="itemcard__content">
								<div class="itemcard__title">
									<a href="#monitoring" class='scrollTo'>Мониторинг <br> клиентской базы </a>
								</div>
							</div>
							<!-- /.itemcard__content -->
						</div>
				...
				<div class="itemcardlist__item itemcardlist__item_col3 itemcardlist__item_icon">
					<div class="itemcard">
						<div class="itemcard__wrapper">
							...
							<div class="itemcard__content">
								<div class="itemcard__title">
									<a href="#scoring" class='scrollTo'>Скоринги <br> и&nbsp;рейтинги </a>
								</div>
							</div>
							<!-- /.itemcard__content -->
						</div>
		...
		<div class="mb-70 xs-mb-50" id='monitoring'>
			...
			<!-- /.titlelink -->
			<div class="itemcardlist itemcardlist--acc">
				<div class="pagetextblock xs-mb-0">
					<div class="row">
						<div class="col-md-6">
							<div class="pagetext">
				...
				<div class="itemcardlist__items itemcardlist__items_type2 itemcardlist--slider" data-slider='slider_card_acc'>
					...
					<div class="itemcardlist__item itemcardlist__item_col3 mb-0 ">
						<div class="itemcard">
