...
$(document).ready(function () {
 ...
 /*  $(function() {
  ...
  $("[data-toggleclick='schme']").on("click", function (e) {
    e.preventDefault()
    $('[data-toggle="schme"]').slideToggle()
 ...
 /*  $(".menubutton").on("click", function (e) {
  ...
  $(".jsbackdrop").on("click", function (e) {
    ...
    $(".mobilemenu__level2").removeClass("active")
    $(".mobilemenu__content").removeClass("active")
    $("[data-toggle='mainmenu']").removeClass("active")
    $('#header').removeClass('active')
    $('[data-toggleclick="mainmenu"]').removeClass('active')
  })
...
/* function handleNumber(evt) {
    ...
    const inp = document.querySelector(`[name="quantity"]`)
    inp.value = inp.getAttribute('value')
        inp.value = (+inp.value + parseFloat(`${inp.step}`)).toFixed(2);
