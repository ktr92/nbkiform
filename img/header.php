...
define('LOGIN_URL', $isCompany ? '' : 'https://person.nbki.ru/');
...
<head>
    ...
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular.woff2" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular.woff" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular.ttf" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Italic.woff2" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Italic.woff" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Italic.ttf" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/FormularMono.woff2" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/FormularMono.woff" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/FormularMono.ttf" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Medium.woff2" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Medium.woff" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="<?= SITE_TEMPLATE_PATH ?>/public/fonts/Formular-Medium.ttf" as="font" type="font/woff2"
        crossorigin>
    
    <link rel="dns-prefetch" href="//top-fwz1.mail.ru">
    <link rel="dns-prefetch" href="//mc.yandex.ru">
    <link rel="dns-prefetch" href="//amc.yandex.ru">
...
<?
    ...
    $start = strtotime("2025-12-29 00:10");
    $end = strtotime("2026-01-08 9:00");
    $now = time();
    ?>

    <? if ($now >= $start && $now <= $end): ?>
        <div class="nypopup ">
            <div class="nypopup__button">
                <img src="/local/templates/nbkiv4/public/img/Snowflake.svg" alt="" class="notactive">
                <img src="/local/templates/nbkiv4/public/img/closebutton.svg" alt="" class="active">
            </div><!-- /.nypopup__button -->
            <div class="nypopup__wrapper">
                <div class="nypopup__content">
                    <p>Дорогие друзья и партнёры НБКИ!</p>
                    <p>Приближается время, когда каждый с нетерпением ожидает услышать звон бокалов под сияющими огоньками
                        ёлки.
                        В этот час мы рады поздравить всех россиян — включая тех, кто ещё не имеет своей кредитной истории —
                        с наступающими праздниками.</p>
                    <p>Мы надеемся, что самые важные и сложные финансовые проблемы меркнут и исчезают в волшебстве
                        новогодней ночи!
                    </p>
                    <p>В наступающем году желаем вам самого главного — добра, любви и тёплого общения с близкими людьми!</p>
                    <p>Но если вы захотите поставить перед собой новые амбициоз-ные задачи, обещаем помочь сделать общение
                        с финансовыми организациями более комфортным и безопасным, а заёмные деньги — чуть менее дорогими.
                    </p>
                    <p>С Новым годом!</p>
                    <p><i>Команда НБКИ,</i></p>
                    <p><i>Председатель совета директоров НБКИ,<br>Президент АРБ,</i></p>
                    <p>академик РАН <br>Гарегин Тосунян</p>
                </div><!-- /.nypopup__content -->
            </div><!-- /.nypopup__wrapper -->
        </div><!-- /.nypopup -->

        <script>
            document.addEventListener('DOMContentLoaded', function () {
                if (localStorage.getItem('nypopup__button')) {
                    $('.nypopup').removeClass('active');
                } else {
                    $('.nypopup').addClass('active');
                }

            })
            $('.nypopup__button').on('click', function () {
                $('.nypopup').toggleClass('active');
                localStorage.setItem('nypopup__button', 'true');
            })
        </script>
    <? endif; ?>
    <? if (1 == 2): ?>
...
*/ ?>
                        ...
                        <div class="twentybanner__bg container" style=''>
                            <span data-action='hidebanner' class='twentybanner__close'>
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    ...
                                    <mask id="mask0_23672_344" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-1"
                            ...
                            <div class="twentybanner__content" style=''>
                                <div class="twentybanner__text">
                                    <a href="https://20.nbki.ru/?utm_source=nbki.ru&utm_medium=banner"
                                        class="twentybanner__title">НБКИ&nbsp;20&nbsp;лет!
                                        День&nbsp;рождения&nbsp;у&nbsp;нас,
                                        а&nbsp;подарки&nbsp;—&nbsp;вам!</a>
                                    <a href="https://20.nbki.ru/?utm_source=nbki.ru&utm_medium=banner"
                                        class="twentybanner__description">Участвуйте и&nbsp;получите шанс выиграть главный
                                        приз&nbsp;— iPhone&nbsp;16&nbsp;Pro</a>


                                </div>
                                <div class="twentybanner__button"><a
                                        href="https://20.nbki.ru/?utm_source=nbki.ru&utm_medium=banner"
            ...
            <div class="container">
                        ...
                        <div class="headermain__item">
                            <div class="headerrow">
                                <div class="burgermenu burgermenu_desktop">
                                    <button class="headermain__menu js-menu js-menu_desktop" aria-label="menu">
                        ...
                        <div class="headermain__item headermain__item_right">
                            ...
                            <div class="searchbutton searchbutton_mobile">
                                        ...
                                        <div class="headerright">
                                            ...
                                            <div class="lklink lklink_mobile">
                                               ...
                                               <? /* <a href="https://person.nbki.ru"
                                                    ...
                                                    <a target="_blank" aria-label="login" href="<?= $isCompany ? 'https://lk.nbki.ru/Cabinet/login/' : 'https://person.nbki.ru/' ?>"
                                                        onclick="ym('9726127','reachGoal', 'lk_click'); _tmr.push({ type: 'reachGoal', id: 3341940, value: 650, goal: 'registratsiya'}); return true;"
                                                        <?= $isCompany ? '' : '' ?>>
                                ...
                                <div class="burgermenu burgermenu_mobile">
                                    <button class="headermain__menu js-menu js-menu_mobile" aria-label="mobmenu">
                            ...
                            <div class="headercenter">
                                ...
                                if ($now >= $start && $now <= $end): ?>
                                    <div class="twentylink twentylink_desktop">
                                        <a href="https://20.nbki.ru/?utm_source=nbki.ru&utm_medium=banner" target="_blank">
                                            <span>НБКИ 20 лет!</span>
                                            <img src="/local/templates/nbkiv4/public/img/twentylink.png" alt=""
                                                class="onlyMobile">
                                ...
                                <? if (!($isJudicial)): ?>
                                    <div class="headerright">
                                        <div class="lklink lklink_desktop">
	                                        ...
	                                        <a target="_blank" href="<?= $isCompany?'https://lk.nbki.ru/Cabinet/login/auth':LOGIN_URL . "" ?>"
                                                onclick="ym('9726127','reachGoal', 'lk_click'); _tmr.push({ type: 'reachGoal', id: 3341940, value: 650, goal: 'registratsiya'}); return true;">
	            ...
	            <div class="search__full" itemscope itemtype="https://schema.org/WebSite">
		            ...
		            <form action="/search/" itemprop="potentialAction" itemscope itemtype="https://schema.org/SearchAction">
			            <meta itemprop="target" content="https://nbki.ru/search/?q={search_term_string}">
			            <meta itemprop="query-input" content="required name=search_term_string">

			            <div class="search__items">
				            <div class="search_wrapper">
					            <input id="title-search-input_fixed"
					                   class="search__input"
					                   type="text"
					                   name="q"
					            ...
					            <span class="search__button_close search__button_open search__button_clear">
						            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
							            ...
							            <mask id="mask0" style="mask-type:alpha" maskUnits="userSpaceOnUse"
								            ...
								            <rect x="-0.027" y="-0.184" width="24" height="24" fill="#D9D9D9"/>
							            </mask>
							            <g mask="url(#mask0)">
								            <path d="M11.97 12.866L6.898 17.94a.75.75 0 0 1-1.06-1.06l5.074-5.075-5.074-5.075a.75.75 0 1 1 1.06-1.06l5.075 5.074 5.074-5.074a.75.75 0 0 1 1.06 1.06l-5.074 5.075 5.074 5.075a.75.75 0 1 1-1.06 1.06l-5.075-5.074Z" fill="#7B7794"/>
							            </g>
						            </svg>
					            </span>
				            </div>
				            ...
				            <div class="search__buttons">
					            <button class="search__submit btn_main" type="submit" aria-label="search">
						            <span>Найти</span>
					            </button>
				            </div>
			            </div>
			            ...
			            <div class="search__results" data-entity="search-wrapper">
				            <div class="searchresults">
					            <div class="searchresults__items" data-entity="search-result"></div>
				            </div>
			            </div>
		            </form>
	            </div>
                    ...
                    <div class="mainmenu__content mainmenu__content--mobile mainmenumob">
                            ...
                            <div class="accordmenu">
                                ...
                                <div class="accordmenu__content">
                                    <ul class="allmenu__lvl1">
                                        ...
                                        <? /* <li><a href="/company/">Реквизиты</a></li> */ ?>
                                    </ul>
                                </div>
                            </div><!-- /.accordmenu -->
                            ...
                            <div class="accordmenu">
                                ...
                                <div class="accordmenu__content">
                                    <ul>
                                        ...
                                        <li><a href="/uslugi-dlya-finansovykh-upravlyayushchikh/">Арбитражным управляющим</a>
                                        </li>
                                    </ul>
                                </div>
                            </div><!-- /.accordmenu -->
                            ...
                            <div class="accordmenu">
                                ...
                                <div class="accordmenu__content">
                                    <ul>
                                        ...
                                        <li><a href="/spor/">Оспорить кредитную историю</a></li>
                                        <li>
                                            <a href="/spor/#footsteps_v6_spor" class="">Исправить паспортные данные</a>
                                        </li>
                                       ...
                                       <? /*		<li><a href="/serviceszaem/historylist/">Справка из ЦККИ</a></li>
                                        ...
                                        <li> <a href="/calculator/" class="">Кредитный калькулятор</a></li>
                                        <li> <a href="/samozapret/" class="">Самозапрет на кредиты</a></li>
                                    </ul>
                                </div>
                            </div><!-- /.accordmenu -->
                            <div class="accordmenu">
                        ...
                        <? else: ?>
                            <div class="mainmenumob__button">
                                <a href="https://person.nbki.ru" class="btn_main btn_main_white" target="_blank">Личный
                                    кабинет</a>
                            </div><!-- /.mainmenumob -->
                        <? endif; ?>
                    ...
                    <div class="headermain">
                        <div class="headermain__items">
                            ...
                            <div class="headermain__item headermain__item_right">
                                <div class="mobilepanel">
                                    <div class="burgermenu burgermenu_mobile">
                                        <button class="headermain__menu js-menu js-menu_mobile active" aria-label="mobile">
                                            <img src="<?= SITE_TEMPLATE_PATH ?>/public/img/hamburger2.svg" alt=""
                    ...
                    <div class="mainmenu__content mainmenu__content--desktop">
                                        ...
                                        <div class="mainmenu__list">
                                            <ul itemscope itemtype="http://www.schema.org/SiteNavigationElement"
                                                ...
                                                <li itemprop="name"><a href="/nbki-history/">Получить кредитную историю</a>
                                                 ...
                                                 <li itemprop="name"><a itemprop="url" href="/pkr/">Персональный кредитный рейтинг</a></li>
                                                <li itemprop="name"><a itemprop="url" href="/spor/">Оспорить кредитную
                                                        историю</a></li>
                                                <li>
                                                    <a href="/spor/#footsteps_v6_spor" class="">Исправить паспортные
                                                        данные</a>
                                                </li>
                                                ...
                                                <li itemprop="name"> <a href="/calculator/" class="">Кредитный
                                                        калькулятор</a></li>

                                                <li itemprop="name"> <a href="/samozapret/" class="">Самозапрет на
                                                        кредиты</a></li>
                                ...
                                <div class="mainmenu__col">
                                    <div class="mainmenu__menu">
                                        ...
                                        <div class="mainmenu__list">
                                            <ul itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                                                <li></li>
                                                <li itemprop="name"><a itemprop="url" href="/corp/">Корпоративным клиентам</a></li>
                        ...
                        <div class="mainmenu__footer mainmenu__cols">
                            ...
                            <div class="mainmenu__links">
                                <div class="mainmenu__title"><a href="https://person.nbki.ru" rel="nofollow" target="_blank"
                                        style="text-decoration: underline;">Войти в
                                        личный кабинет</a></div>
                                <div class="mainmenu__title"><a
                                        href="/uslugi-dlya-finansovykh-upravlyayushchikh/">Арбитражным управляющим</a></div>
                            </div><!-- /.mainmenu__links -->
 ...
 <li>
                                            ...
                                            <li> <a href="/calculator/" class="">Кредитный калькулятор</a></li>
                                            <li>
                                                <a href="/samozapret/" class="">Самозапрет на кредиты</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="accordmenu ">
                                        ...
                                        <div class="accordmenu__content">
                                            <ul class="allmenu__lvl1">
                                                <li><a href="/spor/">Оспорить кредитную
                                                        историю</a></li>
                                                <li><a  href="/historylist/">ЦККИ и код
                                                        субъекта</a></li>
                                                <li>
                                                    <a href="/spor/#footsteps_v6_spor" class="">Исправить паспортные
                                                        данные</a>
                                    ...
                                    <div class="mainmenumob__button mainmenumob__button_v5">
                                        <a href="https://person.nbki.ru" class="btn_main btn_main_v5" target="_blank">Войти
                                            в&nbsp;личный кабинет</a>
                                    </div><!-- /.mainmenumob -->
                                ...
                                <div class="mainmenu__content mainmenu__content--mobile mainmenumob">
                                    ...
                                    <div class="mainmenumob__button mainmenumob__button_v5">
                                        <a href="/uslugi-dlya-finansovykh-upravlyayushchikh/" class="link_blue extlink"
                                            target="_blank">Арбитражным управляющим</a>
                                    </div><!-- /.mainmenumob -->
                            ...
                            <div class="tabs__content" data-tabscontent="tabs_id">
                                <div class="mainmenu__content mainmenu__content--mobile mainmenumob">
                                    ...
                                    <div class="mainmenumob__button mainmenumob__button_v5">
                                        ...
                                        <a href="https://lk.nbki.ru/Cabinet/login/"
                                ...
                                <div class="search__full" itemscope itemtype="https://schema.org/WebSite">
                                    ...
                                    <form action="/search/" itemprop="potentialAction" itemscope
                                        ...
                                        <div class="search__items">
                                            ...
                                            <div class="search__buttons">
                                                <button class="search__submit btn_main" type="submit" aria-label="searchsubmit">
                ...
                <div class="mobilemenu">
                    ...
                    <div class="mobilemenu__wrapper">
                        ...
                        <div class="mobilemenu__item">
                                ...
                                <div class="mainmenu__list">
                                    ...
                                    <li itemprop="name"><a itemprop="url" href="/serviceszaem/code/">Действия с кодом
                                        ...
                                        <li itemprop="name"><a itemprop="url" href="/podpiska-na-credithistory/">Подписка на
                                                кредитную историю</a></li>
                                        <li itemprop="name"><a itemprop="url" href="/pkr/">Кредитный
                                                рейтинг</a></li>
                                        <li> <a href="/calculator/" class="">Кредитный калькулятор</a></li>

                                        <li itemprop="name"> <a href="/samozapret/" class="">Самозапрет на кредиты</a></li>
                            ...
                            <div class="mobilemenu__menu">
                                ...
                                <div class="mainmenu__list">
                                    <ul itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                                        <li itemprop="name"><a itemprop="url"
                                                href="/judicial/svedeniya/">Получить
                                                кредитную
                                                историю</a></li>
                                        <li itemprop="name"><a itemprop="url"
                                                href="/judicial/spor/">Оспорить кредитную
                                                историю</a>
                                        </li>
                                        <li itemprop="name"><a itemprop="url"
                                                href="/judicial/historylist/">Получить сведения из ЦККИ</a></li>
                                        <li itemprop="name"><a itemprop="url"
                                                href="/judicial/historylist/">Действия с кодом субъекта</a>
                                        </li>
                                        <li itemprop="name"><a itemprop="url"
                                                href="/uslugi-dlya-finansovykh-upravlyayushchikh/">Арбитражным
                                                управляющим</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="mobilemenu__links">
                            <a href="https://person.nbki.ru" target="_blank">Войти в&nbsp;личный кабинет</a><br><br>
                        </div>
